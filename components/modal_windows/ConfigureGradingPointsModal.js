...
function configureGradingPointsModal() {
    return (
        <div>
            <div className="modal-content">
				<div className="modal-header">
					<h5 className="modal-title" id="">Configure Grading</h5>
				...
				<div className="modal-footer">
					<button type="button" className="btn btn-primary" id="yesapply">Apply</button>
...
export default configureGradingPointsModal
