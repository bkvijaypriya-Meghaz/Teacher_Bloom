...
function averageTimeSpentAssessment() {
	...
	const chart = () =>{
		setBarData(
			{
				labels:['Gravity Test','Heat & Energy Pop Quiz','Take-Home Quiz','Classifying Matter Test'],
				datasets:[
					{
    ...
    return (
                ...
                <div className="card">
                    <div className="card-header">
                        <h5>Average Time Spent On Assessments</h5>
                    </div>
                    ...
                    <Bar width='10' height='10px'
                        ...
                        options={{
                                ...
                                title: {
                                    display: true,
                                    text: 'Average Time Spent On Assessments',
                                    position:'top',
                                    font:'20'
                                },
                                legend:{
...
export default averageTimeSpentAssessment
